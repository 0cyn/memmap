...
SOCS = {
    ...
    {
        #   Evaluation of memmap for t8002
        #   -DAPPLICATION_IBOOT -DWITH_DFU_MODE
        #
        'SDRAM_BASE' : (0x80000000),
        'SDRAM_LEN' : (0x20000000 ),
        'SDRAM_BANK_LEN' : (0x20000000),
        ...
        'DISPLAY_SIZE' : (4*1024*1024),
        'DISPLAY_BASE' : ((((((((0x80000000 + 0x20000000) - ( 8*1024*1024 )) - 0x00500000) - 0x00004000) - 0x00001000) - 0x00004000) - 0x00080000) - (4*1024*1024)),
        'IBOOT_SIZE' : (0x02000000 + 0x100000 - (0x00080000 + (4*1024*1024))),
        'IBOOT_BASE' : (0x9ee77000 - (0x02000000 + 0x100000 - (0x00080000 + (4*1024*1024)))),

        'INSECURE_MEMORY_SIZE' : ((0x02000000 + 0x100000 - (0x00080000 + (4*1024*1024)))),
        'INSECURE_MEMORY_BASE' : (0x9ee77000 - (0x02000000 + 0x100000 - (0x00080000 + (4*1024*1024)))),

        'STACK_SIZE' : (0x00004000),
        'MMU_TT_SIZE' : (0x00004000),
        'BOOK_KEEPING_SIZE' : (0x00004000 + 0x00004000),
        'BOOK_KEEPING_BASE' : (0x48800000),
        'MMU_TT_BASE' : (0x48800000),
        'STACK_BASE' : (0x48800000 + 0x00004000),

        'TEXT_BASE' : 0x48818000,
        'HEAP_BASE' : (0x48800000 + (0x00004000 + 0x00004000)),
        'HEAP_SIZE' : (0x48818000 - (0x48800000 + (0x00004000 + 0x00004000))),
        'HEAP_END' : ((0x48800000 + (0x00004000 + 0x00004000)) + (0x48818000 - (0x48800000 + (0x00004000 + 0x00004000))))
    },
    {
        #   Evaluation of memmap for t8002
        #   -DAPPLICATION_IBOOT
        ...
        'IBOOT_BASE' : (0x9C000000),
        'IBOOT_SIZE' : ((((0x9C000000) + 0x00100000) + ((((0x9C000000) + 0x00100000) + (0x00004000)) + (0x00004000))) - (0x9C000000)),

        'BOOK_KEEPING_BASE' : ((0x9C000000) + 0x00100000),
        'MMU_TT_BASE' : ((0x9C000000) + 0x00100000),
        'MMU_TT_SIZE' : (0x00004000),
        'STACK_BASE' : (((0x9C000000) + 0x00100000) + (0x00004000)),
        'STACK_SIZE' : (0x00004000),
        'BOOK_KEEPING_SIZE' : ((((0x9C000000) + 0x00100000) + (0x00004000)) + (0x00004000)),

        'HEAP_BASE' : (((0x9C000000) + 0x00100000) + ((((0x9C000000) + 0x00100000) + (0x00004000)) + (0x00004000))),
        'HEAP_SIZE' : (0x9ee77000 - (((0x9C000000) + 0x00100000) + ((((0x9C000000) + 0x00100000) + (0x00004000)) + (0x00004000))) - 4096),
        'HEAP_END' : (0x138208000 + (0x9ee77000 - (((0x9C000000) + 0x00100000) + ((((0x9C000000) + 0x00100000) + (0x00004000)) + (0x00004000))) - 4096)),
        'HEAP_GUARD' : (0x138208000 + (0x9ee77000 - (((0x9C000000) + 0x00100000) + ((((0x9C000000) + 0x00100000) + (0x00004000)) + (0x00004000))) - 4096)),

        'INSECURE_MEMORY_BASE' : (0x80000000),
        'INSECURE_MEMORY_SIZE' : (0x04000000),

        'SECURE_MEMORY_BASE' : (0x80000000 + 0x04000000),
        'SECURE_MEMORY_SIZE' : ((( ((0x80000000 + 0x04000000) + (0x03F00000)) + (0x00100000)) + (0x04000000)) - (0x80000000 + 0x04000000)),

        'DEFAULT_LOAD_ADDRESS' : (0x80000000),
        'DEFAULT_LOAD_SIZE' : (0x04000000),
        'DEFAULT_KERNEL_ADDRESS' : (0x80000000 + 0x04000000),
        'DEFAULT_KERNEL_SIZE' : (0x03F00000),
        'DEFAULT_DEVICETREE_ADDRESS' : ((0x80000000 + 0x04000000) + (0x03F00000)),
        'DEFAULT_DEVICETREE_SIZE' : (0x00100000),
        'DEFAULT_RAMDISK_ADDRESS' : ( ((0x80000000 + 0x04000000) + (0x03F00000)) + (0x00100000)),
        'DEFAULT_RAMDISK_SIZE' : (0x04000000),
        'DEFAULT_FREE_ADDRESS' : (( ((0x80000000 + 0x04000000) + (0x03F00000)) + (0x00100000)) + (0x04000000)),

        'UNUSED_MEMORY_BASE' : ((0x80000000 + 0x04000000) + ((( ((0x80000000 + 0x04000000) + (0x03F00000)) + (0x00100000)) + (0x04000000)) - (0x80000000 + 0x04000000))),
        'UNUSED_MEMORY_SIZE' : ((0x9C000000) - ((0x80000000 + 0x04000000) + ((( ((0x80000000 + 0x04000000) + (0x03F00000)) + (0x00100000)) + (0x04000000)) - (0x80000000 + 0x04000000))))
    }]
}
